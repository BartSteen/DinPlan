...
public class RecyclerViewAdapterIngredient extends RecyclerView.Adapter<RecyclerViewAdapterIngredient.ViewHolder> {
    ...
    //constructor
    public RecyclerViewAdapterIngredient(ArrayList<Ingredient> mIngredients, Context mContext) {
